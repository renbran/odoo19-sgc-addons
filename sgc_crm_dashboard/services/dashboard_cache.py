...
----------
    ...
    from odoo.addons.sgc_crm_dashboard.services.dashboard_cache import (
...
2. **Persistent** (stored in ``ir.config_parameter`` with a TTL):
   ...
   ``sgc_crm_dashboard.cache_ttl_seconds`` (default 0 = disabled).
...
_PARAM_TTL = 'sgc_crm_dashboard.cache_ttl_seconds'
_PARAM_CACHE = 'sgc_crm_dashboard.persistent_cache'
