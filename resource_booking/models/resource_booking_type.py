...
class ResourceBookingType(models.Model):
    ...
    ai_scheduling_enabled = fields.Boolean(
        string="AI Smart Scheduling",
        default=True,
        help="Enable AI-enhanced scheduling suggestions for this booking type.",
    )
    ai_auto_assign = fields.Boolean(
        string="AI Auto-Assign",
        default=False,
        help="Let AI automatically assign the best resource combination based on historical patterns.",
    )
    color = fields.Integer(
        string="Color Index",
        default=0,
        help="Color used for calendar and kanban views.",
    )
